...
require('lazy').setup({
  ...
  { -- Telescope (fuzzy finder, files, lsp, etc)
    ...
    dependencies = {
      ...
      { 'nvim-tree/nvim-web-devicons', enabled = vim.g.have_nerd_font }, -- requires NerdFont
    },
    config = function()
      -- :Telescope help_tags -- try this
      -- - Insert mode: <c-/>
      -- - Normal mode: ? -- show keymaps
